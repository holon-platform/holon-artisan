...
public class DefaultEnumMultiOptionInputFilterBuilder<T extends Enum<T>>
	...
	@Override
	public EnumMultiOptionInputFilterBuilder<T> withReadonlyChangeListener(ReadonlyChangeListener listener) {
	...
	@Override
	public <A> EnumMultiOptionInputFilterBuilder<T> withAdapter(Class<A> type, Function<Input<Set<T>>, A> adapter) {
