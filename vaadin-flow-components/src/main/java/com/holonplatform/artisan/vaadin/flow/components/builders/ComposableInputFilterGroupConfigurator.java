...
/**
 * Compasable {@link InputFilterGroup} configurator.
 * 
 ...
 * @since 1.0.0
 */
public interface ComposableInputFilterGroupConfigurator<E extends HasElement, C extends ComposableInputFilterGroupConfigurator<E, C>>
